...
class ReadAPI:
    ...
    def about(self) -> dict:
        ...
        return {"service": "camber read-api", "ok": True, "sites": self.store.sites()}
    ...
    def points(self, *, site=None, equip=None, role=None) -> dict:
        ...
        rows = [
            {"site": k.site, "equip": k.equip, "role": k.role}
            for k in keys
    ...
    def history(
        self, *, site=None, equip=None, role=None, start=None, end=None, limit=None
    ) -> dict:
