...
class FreeCoolingMissed:
    ...
    def __init__(self, *, high_limit_f: float = 60.0, active: float = 0.05,
    ...
    def analyze(self, equip: str, frame: pd.DataFrame) -> Finding:
        ...
        return Finding(
            ...
            metrics={"missed_pct": round(pct, 2), "high_limit_f": self.high_limit_f,
                     "n_free_cooling_hours": n_avail},
            summary=(f"{equip}: mechanical cooling ran {pct:.0f}% of the "
    ...
    def evidence(self, equip: str, frame: pd.DataFrame):
        ...
        return Evidence(renderer="oat_scatter", roles=[Role.COOL_VALVE],
