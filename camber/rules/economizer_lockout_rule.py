...
class EconomizerHighLimit:
    ...
    def __init__(self, *, high_limit_f: float = 65.0, min_damper: float = 0.25,
    ...
    def analyze(self, equip: str, frame: pd.DataFrame) -> Finding:
        ...
        return Finding(
            ...
            metrics={"not_locked_out_pct": round(pct, 2), "high_limit_f": self.high_limit_f,
                     "min_damper": self.min_damper, "n_above_limit": n_hot},
            summary=(f"{equip}: OA damper open above the {self.high_limit_f:g}°F high limit "
