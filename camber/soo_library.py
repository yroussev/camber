    ...
    *,
    ...
    return [
        Clause(
            ...
            expect=Predicate(R.SUPPLY_AIR_TEMP, "within", ref=R.SUPPLY_AIR_TEMP_SP, tol=sat_tol),
            persistence=persistence,
        ),
        Clause(
            "duct_static_tracks_setpoint",
            when=Predicate(R.SUPPLY_FAN_STATUS, "on"),
            expect=Predicate(R.DUCT_STATIC, "within", ref=R.DUCT_STATIC_SP, tol=static_tol),
            persistence=persistence,
        ),
        Clause(
