...
from camber.agent import build_context  # noqa: E402
from camber.agent import verify, templates  # noqa: E402
...
def _ctx():
    ...
    return build_context(fs, loads={"AHU-1": EquipmentLoad(heating_capacity_kbtuh=200,
                                                           cooling_tons=50)}, price=EnergyPrice())
