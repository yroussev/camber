...
def test_223_minimal_profile_drops_unmapped_roles():
    ...
    eq = Equip(
        ...
        equip_class="AHU",
        points=(
            Point("E1.bs", role=Role.BOILER_STATUS),
...
def test_223_covers_plant_and_refrigerant_roles():
    from camber.interop.semantic223 import _NO_223_QUANTITY, ROLE_TO_223

    # every role is either mapped to a quantity or explicitly documented as unmapped (no silent
    # gaps)
