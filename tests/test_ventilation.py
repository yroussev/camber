...
from camber.rules.ventilation_rule import (  # noqa: E402
    DemandControlledVentilation, VentilationRateProcedure,
)
from camber.ventilation import (  # noqa: E402
    assess_62_1, assess_dcv, oa_rates_for, required_oa_cfm,
)
...
def test_assess_62_1_series_aggregate_and_occupied_mask():
    ...
    r_occ = assess_62_1(oa, area_sqft=2000, population=10, space_type="office",
