...
def _hourly_with_step(days=180, step_day=120, step_kw=10.0, seed=0, weather_light=True):
...
def test_step_change_missed_by_pointwise_screen():
    ...
    e, t, cut = _hourly_with_step(days=180, step_day=120, step_kw=0.6, seed=3, weather_light=False)
