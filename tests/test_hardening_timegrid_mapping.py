...
timegrid was already robust — these lock it. Mapping had a real ReDoS hole (a
catastrophic-backtracking pattern from config could hang the mapper): now rejected at load time.
"""
